...
ckpts_path = r'./checkpoints/LIF_from_CRNN/'
tensorboard_path = r'./tensorboard/LIF_from_CRNN/'
dic_save_path = r'./checkpoints/LIF_from_CRNN/configs_LIF.txt'
log_path = r'./log/LIF_from_CRNN/'
