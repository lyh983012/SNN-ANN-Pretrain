...
ckpts_path = r'./checkpoints/LIAF_from_CRNN/'
tensorboard_path = r'./tensorboard/LIAF_from_CRNN/'
dic_save_path = r'./checkpoints/LIAF_from_CRNN/configs_LIAF.txt'
log_path = r'./log/LIAF_from_CRNN/'
