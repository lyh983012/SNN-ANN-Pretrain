...
ckpts_path = r'./checkpoints/LIF_from_LIAF_CRNN/'
tensorboard_path = r'./tensorboard/LIF_from_LIAF_CRNN/'
dic_save_path = r'./checkpoints/LIF_from_LIAF_CRNN/configs_LIF.txt'
log_path = r'./log/LIF_from_LIAF_CRNN/'
...
model_configs['load_path'] = r'./checkpoints/LIAF_from_CNN1/liaf-epoch56-best.pth.tar'   # note: load checkpoints path
