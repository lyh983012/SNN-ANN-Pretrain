"""
train LIF from pretrained ANN models
"""
...
ckpts_path = r'./checkpoints/LIF_from_RNN/'
tensorboard_path = r'./tensorboard/LIF_from_RNN/'
dic_save_path = r'./checkpoints/LIF_from_RNN/configs_LIF.txt'
log_path = r'./log/LIF_from_RNN/'
