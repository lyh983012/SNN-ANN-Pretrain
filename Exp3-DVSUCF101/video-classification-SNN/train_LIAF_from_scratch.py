...
ckpts_path = r'./checkpoints/LIAF_from_scratch/'
tensorboard_path = r'./tensorboard/LIAF_from_scratch/'
dic_save_path = r'./checkpoints/LIAF_from_scratch/configs_LIAF.txt'
log_path = r'./log/LIAF_from_scratch/'
