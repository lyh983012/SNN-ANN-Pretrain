...
ckpts_path = r'./checkpoints/LIAF_from_RNN/'
tensorboard_path = r'./tensorboard/LIAF_from_RNN/'
dic_save_path = r'./checkpoints/LIAF_from_RNN/configs_LIAF.txt'
log_path = r'./log/LIAF_from_RNN/'
