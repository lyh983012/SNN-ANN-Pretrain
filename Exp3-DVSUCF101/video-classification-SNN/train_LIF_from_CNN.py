...
ckpts_path = r'./checkpoints/LIF_from_CNN/'
tensorboard_path = r'./tensorboard/LIF_from_CNN/'
dic_save_path = r'./checkpoints/LIF_from_CNN/configs_LIF.txt'
log_path = r'./log/LIF_from_CNN/'
