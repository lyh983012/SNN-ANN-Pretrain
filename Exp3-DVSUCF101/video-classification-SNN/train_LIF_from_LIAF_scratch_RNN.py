...
ckpts_path = r'./checkpoints/LIF_from_LIAF_scratch_RNN/'
tensorboard_path = r'./tensorboard/LIF_from_LIAF_scratch_RNN/'
dic_save_path = r'./checkpoints/LIF_from_LIAF_scratch_RNN/configs_LIF.txt'
log_path = r'./log/LIF_from_LIAF_scratch_RNN/'
