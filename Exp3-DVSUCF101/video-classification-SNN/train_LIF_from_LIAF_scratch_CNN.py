...
ckpts_path = r'./checkpoints/LIF_from_LIAF_scratch_CNN/'
tensorboard_path = r'./tensorboard/LIF_from_LIAF_scratch_CNN/'
dic_save_path = r'./checkpoints/LIF_from_LIAF_scratch_CNN/configs_LIF.txt'
log_path = r'./log/LIF_from_LIAF_scratch_CNN/'
