...
ckpts_path = r'./checkpoints/LIF_from_scratch/'
tensorboard_path = r'./tensorboard/LIF_from_scratch/'
dic_save_path = r'./checkpoints/LIF_from_scratch/configs_LIF.txt'
log_path = r'./log/LIF_from_scratch/'
