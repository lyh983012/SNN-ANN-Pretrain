...
class LIAFResNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        finalDataSize = (1,1)
        self.post_pooling = nn.AdaptiveAvgPool2d(finalDataSize) 
        

        self.cfgFc_ = [512 *self.block.expansion * finalDataSize[0] * finalDataSize[1]]
    ...
    def forward(self,input):
        with autocast():
            ...
            for time in range(self.timeWindows):
                pool = self.post_pooling(output[:,:,time,:,:])
