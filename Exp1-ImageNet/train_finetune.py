...
if __name__ == '__main__':
    ...
    train_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[2, 4, 6, 8], gamma=0.3)
    ...
    Path = "checkpoint/WSresnet18/1536/0.6/WS-T6SNN-Fast/WSresnet18-100-regular.pth"  # change to your ckpt
