...
if __name__ == '__main__':
    ...
    parser.add_argument('-weights', type=str, default="resnet34.pth", help='the weights file you want to test')
    parser.add_argument('-net', type=str, required=True, help='net type')
    parser.add_argument('-gpu', type=bool, default=True, help='use gpu or not')
    parser.add_argument('-b', type=int, default=400, help='batch size for dataloader')
    ...
    net.load_state_dict({k.replace('module.', ''): v for k, v in torch.load(args.weights)['model_state_dict'].items()})
    net.cuda()
